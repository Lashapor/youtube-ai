      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <header className="text-center mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Ask AI anything about any YouTube video
          </p>
        </header>
        ...
        {step === "chat" && (
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3">
              <div className="bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg shadow-sm">
                      ...
                      <div className={`flex gap-3 max-w-xs lg:max-w-md ${message.type === "user" ? "flex-row-reverse" : "flex-row"}`}>
                        <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center ${message.type === "user" ? "bg-blue-100 dark:bg-blue-900/20" : "bg-slate-100 dark:bg-slate-700"}`}>
                          {message.type === "user" ? (
                            ...
                            <svg className="w-4 h-4 text-slate-600 dark:text-slate-400" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                              <path d="M16.5 7.063C16.5 10.258 14.57 13 12 13s-4.5-2.742-4.5-5.937C7.5 3.868 9.16 2.5 12 2.5s4.5 1.368 4.5 4.563z"/>
                              <path d="M12 15.5c1.657 0 3.157-.672 4.243-1.757.086-.086.185-.17.257-.264v2.021c0 2.485-2.239 4.5-5 4.5s-5-2.015-5-4.5v-2.021c.072.094.171.178.257.264C8.843 14.828 10.343 15.5 12 15.5z"/>
                            </svg>
                          )}
                        </div>
                        <div className={`rounded-lg p-3 ${message.type === "user" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-slate-100"}`}>
